        ...
        <div className="content-max">
          ...
          <div className="lg:hidden">
            ...
            >
              ...
              <h2 className="font-display font-bold text-[28px] leading-[1.1] text-slate-900 mb-5">
                Four friends,{" "}
              ...
              <p className="text-[15px] text-slate-600 leading-[1.75] mb-6">
                In 2024, four friends who grew up exploring Sri Lanka turned their passion into purpose.
                Today, Aitken Travels operates 50+ vehicles &mdash; from sedans to Royal Enfields &mdash; serving
                travellers from over 30 countries with drivers who know every shortcut and hidden gem on the island.
              </p>

              <div className="flex items-center gap-4 mb-8 pt-5 border-t border-slate-200">
          ...
          <div className="hidden lg:grid lg:grid-cols-2 gap-20 xl:gap-24 2xl:gap-32 items-center">
            ...
            >
              ...
              <div className="space-y-5 text-[16px] text-slate-600 leading-[1.75]">
                <p>
            ...
            >
              ...
              <div className="absolute -bottom-6 -left-8 z-20 bg-white rounded-2xl shadow-elevation-2 p-5 border border-slate-100">
              ...
              <div className="absolute -top-3 -right-6 z-20 bg-white rounded-xl shadow-elevation-2 px-4 py-3 border border-slate-100">
