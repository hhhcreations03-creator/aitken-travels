  ...
  return (
    <section id="contact" className="py-[80px] md:py-[120px] px-6 md:px-10 lg:px-16 bg-gradient-to-b from-white via-primary-50/30 to-primary-50/60 overflow-hidden">
      <div className="content-max">
        ...
        {/* Steps — 3 columns */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-0 mb-16 md:mb-20 relative">
            ...
            <div className="flex flex-col items-center lg:items-end gap-5">
              <div className="flex flex-wrap gap-3 justify-center lg:justify-end">
                <button
                  ...
                  className="bg-gradient-to-r from-primary-500 to-primary-400 text-white rounded-full px-8 py-4 font-semibold text-[15px] hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(45,212,191,0.3)] transition-all duration-300 min-h-[52px] cursor-pointer flex items-center gap-2"
                >
                  Book a vehicle
                ...
                <a
                  ...
                  className="border border-white/15 text-white rounded-full px-8 py-4 font-medium text-[15px] hover:bg-white/10 transition-all duration-300 min-h-[52px] inline-flex items-center gap-2"
                >
              ...
              <div className="flex flex-wrap gap-x-5 gap-y-1 justify-center lg:justify-end">
